...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--weight_path",
        type=str,
        default="weights2/yolov4.weights",
    ...
    parser.add_argument("--log_path", type=str, default="log-6improved-channel-spatial2/", help="log path")
    parser.add_argument(
        "--accumulate",
        type=int,
        default=2,
    ...
    logger = Logger(
        log_file_name=opt.log_path + "/log-6improved-channel-spatial2.txt",
