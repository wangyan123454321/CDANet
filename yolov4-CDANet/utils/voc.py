...
'''
Convert data format :use utils/voc.py or utils/coco.py convert the pascal voc *.xml format 
(COCO *.json format)to *.txt format (Image_path &nbsp; xmin0,ymin0,xmax0,ymax0,class0 &nbsp; 
xmin1,ymin1,xmax1,ymax1,class1 &nbsp;...).

'''
def parse_voc_annotation(
    # data_path, file_type, anno_path, use_difficult_bbox=False
    data_path="/data/article/yolov4/VOCdevkit/VOC2007", 
    file_type="train",
    anno_path='/data/article/yolov4/VOCdevkit/VOC2007/Annotations', 
...
#     #     "/data/article/YOLOv4-pytorch-baseline/data/VOCdevkit/VOC2007/",
#     # )
#     train_data_path_2012 = os.path.join(
#         # cfg.DATA_PATH, "VOCtrainval-2012", "VOCdevkit", "VOC2012"
#         "/data/article/yolov4/VOCdevkit/VOC2012/"
#     )
...
#         "/data/article/yolov4/VOCdevkit/VOC2007/"
#     )
...
if __name__ == "__main__":
    ...
    train_annotation_path = os.path.join("/data/article/yolov4/1-none/data/train_annotation.txt")
    if os.path.exists(train_annotation_path):
        os.remove(train_annotation_path)
    ...
    test_annotation_path = os.path.join("/data/article/yolov4/1-none/data/test_annotation.txt")
    if os.path.exists(test_annotation_path):
        os.remove(test_annotation_path)
